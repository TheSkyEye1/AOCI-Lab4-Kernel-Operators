# Лабораторная работа №1. Операции с Ядрами (Свертка) на C# WPF и Emgu.CV (АОЦИ)
...
[<-- Предыдущая работа](https://github.com/TheSkyEye1/AOCI-Simple-Image-Redactor-EmguCV) | [Следующая работа -->]()
